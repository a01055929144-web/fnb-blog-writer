...
function fetchPrice_(params) {
  ...
  try {
    ...
    // 업종별 우선 품목 키워드 목록 — 식당에서 실제 쓰는 품목
    var priorityMap = {
      '한식':      ['양파','대파','마늘','배추','상추','깻잎','시금치','무','오이','고추',
                    '삼겹살','목심','앞다리','닭','계란','돼지'],
      '양식':      ['양파','파프리카','브로콜리','시금치','오이','호박','상추','마늘',
                    '소','안심','삼겹살','닭','계란','딸기','키위','바나나'],
      '일식':      ['고등어','갈치','오징어','낙지','새우','명태','조기','김',
                    '상추','무','오이','시금치'],
      '중식':      ['대파','마늘','양파','배추','무','고추','오이',
                    '돼지','삼겹살','목심','닭','계란'],
      '샐러드':    ['상추','시금치','파프리카','오이','브로콜리','깻잎','호박',
                    '딸기','사과','키위','바나나','포도','배'],
      '축산':      ['삼겹살','목심','앞다리','갈비','안심','닭','오리','계란',
                    '돼지','소'],
      '수산':      ['고등어','갈치','오징어','낙지','새우','명태','조기','김',
                    '상추','무','오이'],
      '공산품':    ['쌀','찹쌀','콩','팥','녹두','들깨','참깨','땅콩',
                    '배추','양파','마늘'],
      '주류':      ['배추','양파','마늘','오이','무','시금치'],
      '카페베이커리': ['딸기','바나나','키위','사과','포도','참외','수박','복숭아',
                      '계란','쌀']
    };
    var priorities = priorityMap[key] || [];

    // category_code로 업종별 필터 + 우선 품목 정렬 + 최대 8개
